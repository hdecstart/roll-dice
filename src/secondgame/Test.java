...
import static util.Operation.getMean;
import static util.Operation.getStandardDeviation;
import static util.Operation.getVariance;
import static util.Operation.rollDice;
...
public class Test {
    ...
    static final int NUMBER_ROLL_DICE = 2;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < NUMBER_PLAY; i++) {
            for (int j = 0; j < NUMBER_ROLL_DICE; j++) {
                ...
                if (result[0] == NUMBER_WINER && result[1] == NUMBER_WINER) {
                    winList.add(i);
                    countWin++;
                    break;
                } else {
